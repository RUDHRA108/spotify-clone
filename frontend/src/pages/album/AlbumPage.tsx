			...
			<ScrollArea className='h-full rounded-md'>
					...
					<div className='relative z-10'>
						<div className='flex flex-col sm:flex-row p-4 sm:p-6 gap-4 sm:gap-6 pb-8'>
							<img
								...
								className='w-48 h-48 sm:w-[240px] sm:h-[240px] shadow-xl rounded flex-shrink-0 mx-auto sm:mx-0'
							/>
							<div className='flex flex-col justify-end w-full'>
								...
								<div className='flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2 text-xs sm:text-sm text-zinc-100'>
                ...
                hover:scale-105 transition-all'
						...
						<div className='bg-black/20 backdrop-blur-sm'>
							{/* table header */}
							<div
								className='hidden sm:grid grid-cols-[16px_4fr_2fr_1fr] gap-4 px-6 sm:px-10 py-2 text-xs sm:text-sm 
            text-zinc-400 border-b border-white/5'
									...
									{currentAlbum?.songs.map((song, index) => {
										...
										return (
											<div
												...
												className={`hidden sm:grid grid-cols-[16px_4fr_2fr_1fr] gap-4 px-4 py-2 text-xs sm:text-sm 
                      ...
                      text-zinc-400 hover:bg-white/5 rounded-md group cursor-pointer`}
											>
												...
												<div className='text-xs text-zinc-400 flex-shrink-0'>{formatDuration(song.duration)}</div>
											</div>
										);
									})}
								</div>
